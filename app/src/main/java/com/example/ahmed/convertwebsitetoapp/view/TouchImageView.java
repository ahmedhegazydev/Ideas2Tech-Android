...
public class TouchImageView extends /*android.support.v7.widget.AppCompatImageView*/ImageView {
	 ...
	 * coordinate system of the drawable that the image_sample contain
	 * 
	 * @param x
